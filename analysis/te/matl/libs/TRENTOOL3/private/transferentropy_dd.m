function [TEresult]=transferentropy_dd(cfg, data, varargin)
        ...
        for t4t = 1:nrtrials(channelpair,2)
            ...
            elseif strcmp(cfg.shuffle, 'yes')
                ...
                switch cfg.surrogatetype
                    ...
                    case 'dd_blockreverse1'
                        % This is a silly way of creating random blocks, but it works.
                        trial2 = t4t;
                        
                        len=timeindices(2)-timeindices(1)+1;
                        xr=round(abs(randn(len,1)*1000));
                        xr=cumsum(xr);
                        ...
                        t=flipud(t);
                        timespan = t'+timeindices(1)-1;
                        
                    case 'dd_blockreverse2'
                        trial2 = trial1;
                        
                        len=timeindices(2)-timeindices(1)+1;
                        xr = (timeindices(1)+10:timeindices(2)-10)';
                        ...
                        t=flipud(t);
                        timespan=t'+timeindices(1)-1; %plot(timespan);pause
            ...
            if shifttest == 1
                ...
                timespan(timespan==0)=[];
                try a=squeeze(data4TE{channelpair,1}(trial1,timespan));catch;keyboard;end
    ...
    for channelpair = 1:size(channelcombi,1)
        ...
        parfor t4t = 1:nrtrials(channelpair,2)
            ...
            if shifttest == 1
                ...
                if strcmp(cfg.surrogatetype,'dd_blockreverse')
                    a=squeeze(data4TE{channelpair,1}(trial1,timespan));
                    %b=squeeze(data4TE{channelpair,2}(trial2,timeindices(1):timeindices(2)));
                    b=squeeze(data4TE{channelpair,2}(trial2,timespan));
                else
                    a=squeeze(data4TE{channelpair,1}(trial1,timespan));
                    b=squeeze(data4TE{channelpair,2}(trial2,timespan));
