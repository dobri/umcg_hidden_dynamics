function TEpermtest=TEsurrogatestats_many(cfg,data,shuffle_n)
...
if isfield(cfg, 'numpermutation') && strcmp(cfg.numpermutation, 'findDelay');
    ...
    cfg.numpermutation = cfg.numpermutation ;
end
...
if shuffle_n>0
    ...
    cfg = rmfield(cfg, 'shuffle');
    TEpermtest.TEmat_shuffle = TEmat_sur;
end
